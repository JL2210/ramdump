...
# Argument constants
INCDIRS  = $(SRCDIR)/ $(SRCDIR)/include/ $(SRCDIR)/include/hardware.inc/
WARNINGS = all extra
# padding between sections should be zero
ASFLAGS  = -p 0x00 $(addprefix -i,$(INCDIRS)) $(addprefix -W,$(WARNINGS))
LDFLAGS  = -p $(PADVALUE)
